...
import 'package:rent_straight_landlord/UploadHouse/upload_house_7.dart';
import 'package:rent_straight_landlord/constants.dart';
import 'package:shared_preferences/shared_preferences.dart';


class UploadHouse6 extends StatefulWidget {
  const UploadHouse6({super.key});

  @override
  State<UploadHouse6> createState() => _UploadHouse6State();
}

class _UploadHouse6State extends State<UploadHouse6> {
...
*//*
                                        ...
                                        Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => UploadHouse7()));
                                            },
                                      child: Container(
